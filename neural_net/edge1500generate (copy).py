    ...
    for snode,enode,d in G.edges_iter(data=True):
        ...
        for row in metapaths:
            ...
            if(len(row)==2):
                ...
                type12 = type1+type2
                # try:
                #     num12 = graph[type12][str(node1) + '|' + str(node2)]
                ...
                #     num12 = 0
                # try:
                #     num23 = graph[type23][str(node2) + '|' + str(node3)]
                # except KeyError as E:
                #     # print(E)
                #     num23 = 0    
                num12 = graph[type12].get(str(node1) + '|' + str(node2),0)
                ...
                #     num12 = graph[type12][str(node1) + '|' + str(node2)]
                # except KeyError as E:
                #     # print(type12,'12 key:', E)
                #     num12 = 0
                # try:
                #     num23 = graph[type23][str(node2) + '|' + str(node3)]
                # except KeyError as E:
                #     # print(type23,'23 key:',E)
                #     num23 = 0    
                # try:
                #     num34 = graph[type34][str(node3) + '|' + str(node4)]
                # except KeyError as E:
                #     # print(type34,'34 key:',E)
                #     num34 = 0 
                num12 = graph[type12].get(str(node1) + '|' + str(node2),0)
                num23 = graph[type23].get(str(node2) + '|' + str(node3),0)
...
#                 print(num12,num23,num34)
#                 print(den1,den2,den3)
#                 print(prob12,prob23,prob34)
...
with open("meta"+str(sys.argv[1])+".pickle","wb") as file:
