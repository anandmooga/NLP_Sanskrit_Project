...
SELECT e.Lemma, 'Lemma', n.Lemma, 'Lemma', COUNT(DISTINCT e.Filename)
...
--Lemma CNG Edge
INSERT INTO Graph( Entity_1, Type_1, Entity_2, Type_2, Weight)
SELECT e.Lemma, 'Lemma', substr(n.CNG, -4, 4), 'CNG', COUNT(DISTINCT e.Filename)
FROM Extracted e, Node n
WHERE e.Filename = n.Filename AND e.rowid <> n.rowid
...
--Lemma Word Edge
INSERT INTO Graph( Entity_1, Type_1, Entity_2, Type_2, Weight)
SELECT e.Lemma, 'Lemma', n.Word, 'Word', COUNT(DISTINCT e.Filename)
FROM Extracted e, Node n
WHERE e.Filename = n.Filename AND e.rowid <> n.rowid
...
--CNG CNG Edge
INSERT INTO Graph( Entity_1, Type_1, Entity_2, Type_2, Weight)
SELECT substr(e.CNG, -4, 4), 'CNG', substr(n.CNG, -4, 4), 'CNG', COUNT(DISTINCT e.Filename)
FROM Extracted e, Node n
WHERE e.Filename = n.Filename AND e.rowid <> n.rowid
...
--CNG Word Edge
INSERT INTO Graph( Entity_1, Type_1, Entity_2, Type_2, Weight)
SELECT substr(e.CNG, -4, 4), 'CNG', n.Word, 'Word', COUNT(DISTINCT e.Filename)
FROM Extracted e, Node n
WHERE e.Filename = n.Filename AND e.rowid <> n.rowid
...
--CNG Lemma Edge
INSERT INTO Graph( Entity_1, Type_1, Entity_2, Type_2, Weight)
SELECT substr(e.CNG, -4, 4), 'CNG', n.Lemma, 'Lemma', COUNT(DISTINCT e.Filename)
FROM Extracted e, Node n
WHERE e.Filename = n.Filename AND e.rowid <> n.rowid
...
--Word CNG Edge
INSERT INTO Graph( Entity_1, Type_1, Entity_2, Type_2, Weight)
SELECT e.Word, 'Word', substr(n.CNG, -4, 4), 'CNG', COUNT(DISTINCT e.Filename)
FROM Extracted e, Node n
WHERE e.Filename = n.Filename AND e.rowid <> n.rowid
